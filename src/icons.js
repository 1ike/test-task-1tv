...
const createSVGElem = (path, classNamePostfix, viewBox = '0 0 512 512') => {
  ...
  setAttributes(icon, {
    className: `${namespace}__icon-${classNamePostfix}`,
    viewBox,
    role: 'img',
    'aria-hidden': 'true',
    height: 30,
...
export const muteOnIcon = createSVGElem(muteOnPath, 'muteOn', '0 0 550 550');
